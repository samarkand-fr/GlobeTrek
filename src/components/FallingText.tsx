...
const FallingText: React.FC<FallingTextProps> = ({
        ...
        .map((word) => {
          ...
          return `<span
            class="inline-block mx-[2px] select-none ${
              isHighlighted ? "text-cyan-500 dark:text-cyan-300 font-bold" : ""
            }"
          >
            ${word}
          </span>`;
    ...
    useEffect(() => {
        ...
        const canvasContainer = canvasContainerRef.current; // ✅ Store ref in variable
        ...
        return () => {
            ...
            if (render.canvas && canvasContainer) { // ✅ Use stored variable
